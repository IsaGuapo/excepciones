...
Ejercicios
Crea una excepción propia llamada ExcepcionPrueba, que va a contener los atributos (nombre y respuesta), respuesa se recibe por parámetros.
Modifica el prototipo de manera que se pueda incluírse el nombre y la respuesta cuando se construya un objeto de ExcepcionPrueba.
Lanza una excepción de ExcepcionPrueba dentro de un try y captúrala desde un catch.
